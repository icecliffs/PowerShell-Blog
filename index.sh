...
echo -n "          <li><a href='https://www.icecliffs.cn/links'>Links(L)</a></li>"
echo -n "          <li><a href='https://www.icecliffs.cn/status'>Status(S)</a></li>"
echo -n "          <li><a href='javascript:window.opener=null;window.open('','_self');window.close();'>Exit(E)</a></li>"
echo -n "     </ul>"
echo -n "</header>"
...
echo -n "</span>"
echo -n "<span><span class='shell-blue'>&nbsp;❯&nbsp;</span><span class='shell-yellow'>&nbsp;cat&nbsp;</span><span class='shell-red'>/etc/motd</span></span>"
echo -n "<pre>"
echo -n "<code>"
cat /etc/motd
echo -n "</code>"
